...
export const RegisterForm = () => {
  ...
  return (
    <form className="text-black">
      ...
      <button disabled={isSubmitting} className="bg-accent text-white font-semibold uppercase rounded-md py-3 transition-all hover:bg-accent-hover disabled:opacity-50 w-full mt-4 cursor-pointer">{isSubmitting ? "Enviando..." : "Continuar"}</button>
    </form>
  );
};
